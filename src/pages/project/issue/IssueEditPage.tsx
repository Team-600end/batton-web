  ...
  return (
    <>
      ...
      <div className="flex flex-col">
        ...
        {/* 이슈 관리 페이지 */}
        <div className="flex items-center justify-between ml-auto mr-auto mt-10" style={{ height: "4.2770vh", width: "63.2275vw" }}>
          <div className="flex flex-row justify-start">
            <input className="px-3 font-bold text-[28px] text-gray-900 jusitfy-start" value={"[600&-12] 사용자 프로필 수정 기능"} style={{ width: "40vw" }} />
          </div>
        ...
        <div className="flex flex-row">
          ...
          <div className="flex flex-col items-top  mt-20" style={{ width: "63.2275vw" }}>
            <button
              id="dropdownButton"
