...
export default function NoticeDetailPage() {
    return (
        <div className="flex flex-col ml-40 my-10">
                ...
                <img src={arrow_left} />
                <div className="ml-5 text-green-400 text-base font-medium">이전으로 돌아가기</div>
            </div>
              <div className="flex flex-row ml-52">
                <div className="flex flex-col">
                    <div className="text-black text-3xl font-bold">내 알림함</div>
                    <div className="mt-10 w-32 text-sm text-center font-medium text-gray-900 bg-white border border-gray-200 rounded-lg">
                ...
                <div className="ml-[50px] mt-[75px] w-[600px] bg-white rounded-xl shadow border border-gray-200">
                    <div className="h-16 pl-5 pr-8 py-3 border-b border-gray-200 justify-start items-center gap-7 inline-flex">
                        ...
                        <div className="flex justify-start items-center gap-1.5 flex">
                            <div className="w-96 text-[0.850rem]">@이서현 님이 이슈를 끝냈습니다. @임혜균 님 이제 다음이슈를 바톤터치받아 진행해 주세요!</div>
                            <div className="w-24 text-right text-green-400 text-xs font-normal leading-none flex items-center">10 minutes ago</div>
                        </div>
                    </div>
                </div>
            </div>
