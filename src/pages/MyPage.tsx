        ...
        <>
            <div className="relative w-screen h-screen flex flex-col overflow-hidden">
                ...
                <div className="flex flex-row w-screen " style={{}}>
                    <div className="flex flex-col w-screen mt-[80px] items-center" style={{ width: '13.8889vw', marginLeft: '24.2540vw' }}>
                    ...
                    <div className="flex flex-col mt-[80px] ml-[64px]" style={{ width: '28.3730vw' }}>
                        <div>
                            ...
                            <div className="flex items-center justify-center w-full">
                                <label for="dropzone-file" className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                        ...
                                        <p className="mb-2 text-sm text-gray-500 dark:text-gray-400"><span class="font-semibold"></span>이미지를 클릭하거나 드래그하여 업로드하세요</p>
                ...
                <div className="flex flex-row justify-center space-x-5" style={{marginTop: '12.2159vh'}}>
