  ...
  return (
    <>
      <div className="flex flex-col mb-20">
          ...
          <ol className="inline-flex items-center space-x-1 md:space-x-3 mt-14">
            ...
            <li aria-current="page">
              <div className="flex items-center">
                ...
                <span className="ml-1 text-md font-medium text-primary-4 md:ml-2 dark:text-gray-400">이슈 관리</span>
              </div>
            </li>
          </ol>
        </nav>
        ...
        {/* 이슈 관리 페이지 */}
        <div className="flex items-center justify-between ml-auto mr-auto mt-6" style={{ height: "4.2770vh", width: "63.2275vw" }}>
        ...
        <div className="flex flex-row mt-4 ml-auto mr-auto" style={{ width: "54.3651vw" }}>
          <div className="flex flex-col w-full justify-center items-start" style={{ width: "18.8175vw", marginLeft: "11vw" }}>
            <p className="font-semibold text-[18px] text-gray-900 mt-10">상태</p>
            <p className="font-semibold text-[18px] text-gray-900 mt-10">설명</p>
            <p className="font-semibold text-[18px] text-gray-900 mt-10">태그</p>
            <p className="font-semibold text-[18px] text-gray-900 mt-12">담당자</p>
          </div>
        ...
        <div className="flex flex-col mr-auto ml-auto" style={{ width: "54.3651vw" }}>
        ...
        <div className="flex mr-auto ml-auto" style={{ width: "54.3651vw" }}>
          <div className="flex flex-col w-full  items-start" style={{ width: "8.8175vw", marginLeft: "11vw" }}>
            <p className="font-semibold text-[18px] text-gray-900 mt-10">다음 이슈</p>
