            ...
            <div id="dropdownNotification" className="z-20 w-[400px] bg-white divide-y divide-gray-100 rounded-lg shadow-lg">
                ...
                <div className="flex items-center justify-center">
                    <ul className="flex flex-wrap -mb-px text-sm font-suitM">
                        <li className="ml-3">
                            <button className={`inline-block p-4 border-b-2 rounded-t-lg hover:text-[#5AAE8A] hover:border-[#5AAE8A] ${activeButton === '전체' ? 'text-[#5AAE8A] border-[#5AAE8A]' : 'border-[#FFFFFF]'}`}
                                onClick={() => handleClick('전체')}>전체</button>
                        </li>
                        <li className="ml-12">
                            <button className={`inline-block p-4 border-b-2 rounded-t-lg hover:text-[#5AAE8A] hover:border-[#5AAE8A] ${activeButton === '이슈' ? 'text-[#5AAE8A] border-[#5AAE8A]' : 'border-[#FFFFFF]'}`}
                                onClick={() => handleClick('이슈')}>이슈</button>
                        </li>
                        <li className="ml-9">
                            <button className={`inline-block p-4 border-b-2 rounded-t-lg hover:text-[#5AAE8A] hover:border-[#5AAE8A] ${activeButton === '프로젝트' ? 'text-[#5AAE8A] border-[#5AAE8A]' : 'border-[#FFFFFF]'}`}
                                onClick={() => handleClick('프로젝트')}>프로젝트</button>
                        </li>
                    </ul>
                </div>
                ...
                <Link to="/notifications" className="block py-2 text-sm font-suitM text-center text-gray-900 rounded-b-lg bg-gray-50 hover:bg-gray-100"
