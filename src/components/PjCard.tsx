        ...
        <div className="relative w-[350px] h-[250px] flex flex-col items-center justify-start">
          ...
          <div className="relative w-[300px] h-[70px] mt-[10px] flex flex-row">
            ...
            <div className="flex-col ml-[20px] mt-[5px]">
              <p className="text-[#5AAE8A] text-2xl font-bold">600&</p>
              <div className="flex flex-row items-center justify-center mt-[2px]">
                ...
                <p className="ml-[5px] text-[#707070] font-semibold">v 3.0.6</p>
              </div>
            </div>
          </div>

          {/* 프로젝트 개수 모음 */}
          <div className="relative w-[300px] h-[50px] mt-[10px] pl-[15px] flex flex-col">
          ...
          <div className="relative w-[300px] h-[30px] mt-[10px]">
            <div className="flex -space-x-4">
              ...
              <img className="w-[30px] h-[30px] border-[1px] border-white rounded-full dark:border-gray-800" src={avatar} alt="" />
              <a
                className="flex items-center justify-center w-[30px] h-[30px] text-xs font-medium text-white bg-gray-700 border-[1px] border-white rounded-full hover:bg-gray-600 dark:border-gray-800"
                href="#"
              >
                +2
              </a>
              <p className="text-sm font-normal text-[#C4C4C4] mt-[5px] pl-[30px] ">이승희님 외 2명</p>
            </div>
          </div>
          ...
          <div className="relative w-[300px] h-[30px]">
            <div className="flex justify-between mb-1">
              ...
              <span className="text-sm font-medium text-[#6B7280] dark:text-white">45%</span>
            </div>
