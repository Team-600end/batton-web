    ...
    <div className="relative w-screen h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="flex flex-col space-y-6 relative z-10 items-center justify-center w-[38vw] p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8">
        <form className="space-y-6 w-[30vw]">
          <h4 className="text-xl font-medium text-gray-900">로그인</h4>
          <div>
        ...
        <button type="button" className="w-[30vw] h-[7vh] text-black bg-[#FEE500] shadow-md hover:bg-[#E2CC00] focus:ring-4 focus:outline-none focus:ring-[#F9F9F9] font-medium rounded-lg text-sm px-5 py-2.5 text-center flex justify-center items-center">
          <img className="mr-2 w-[1.3vw]" src={kakao_logo_img} /> 카카오 로그인 
        </button>
        <button type="button" className="w-[30vw] h-[7vh] text-gray-400 bg-[#FFFFFF] border border-grey-100 shadow-md hover:bg-[#E7E7E7] focus:ring-4 focus:outline-none focus:ring-[#F9F9F9] font-medium rounded-lg text-sm px-5 py-2.5 text-center flex justify-center items-center">
