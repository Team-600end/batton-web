  ...
  return (
    <>
      <div className="w-[220px] h-[400px] p-[10px] mx-[100px] my-[100px] shadow-[2px_6px_10px_-2px_rgba(0,0,0,0.3)] border-[0.3px] bg-white rounded-lg shadow mx-2 dark:bg-gray-800 dark:hover:bg-gray-700">
        <p className="p-2 mb-6 font-semibold">프로젝트 멤버</p>

        {/* map 반복문 사용 */}
        <div className="flex flex-row h-[38px] my-2 items-center justify-center text-green-700 bg-white border border-green-500 font-medium rounded-lg hover:bg-gray-50 text-sm px-5 py-2.5 dark:bg-green-600">
          <img className="w-[24px] h-[24px] rounded-full" src={avatar_img} alt="avatar" />
          <div className="w-full px-[10px] text-sm text-gray-500 font-medium dark:text-white dark:text-gray-400">Jese Leos</div>
        ...
        <button
          type="button"
          className="w-full h-[38px] text-[#285F43] mt-[5px] bg-white border border-[#285F43] hover:bg-[#285F43] hover:text-[#FFFFFF] font-medium rounded-full text-sm"
        >
          + 새 맴버 초대하기
        </button>
        {isDropdownOpen && (
