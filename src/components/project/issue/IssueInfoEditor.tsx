  ...
  return (
    <div className="flex flex-col mt-[5vh] mx-auto w-[50vw] px-[7vw] space-y-5">
      ...
      <div className="flex">
        ...
        <input value={issueContentInput} onChange={handleIssueContentInput} type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block focus:border-gray-300 focus:ring-0 ml-auto my-auto w-[27vw] resize-none" />
      </div>
