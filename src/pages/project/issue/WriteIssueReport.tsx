    ...
    <>
      ...
      <div className="w-[90vw] m-auto mt-[10vh] flex flex-col">
        <div className="flex flex-row my-7">
          ...
          <span className="bg-yellow-100 text-yellow-800 text-xs font-suitM mr-2 px-2.5 py-0.5 rounded border border-yellow-300">CHANGED</span>
        </div>
        {/* <p className="text-sm font-medium text-gray-900 dark:text-white flex justify-start">
          작업내용
        </p> */}
        <form className="flex justify-center mt-2">
          <div className="w-[70vw] mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600 ">
            ...
            <div className="flex items-center justify-between px-3 py-2 border-t dark:border-gray-600">
              <button
                type="submit"
                className="inline-flex items-center py-2.5 px-4 text-xs font-medium text-center text-white bg-green-500 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-green-600"
              >
                작성하기
              </button>
