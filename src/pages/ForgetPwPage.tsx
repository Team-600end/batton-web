...
export default function ForgetPwPage() {
    return (
      <div className="relative w-screen h-screen flex flex-col items-center justify-center overflow-hidden">
        <img className="absolute z-0" src={signup_hand_image} style={{marginTop: '54vh', marginLeft: '-45vw'}}/>
        ...
        <div className="flex flex-col space-y-6 relative z-10 items-center justify-center w-[38vw] p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8">
          <form className="space-y-6 w-[30vw]">
            <h4 className="text-xl font-medium text-gray-900">비밀번호 찾기</h4>
            <div>
          ...
          <button type="submit" className="w-full text-white bg-[#5AAE8A] shadow-md hover:bg-[#285F43] focus:ring-4 focus:outline-none focus:ring-[#F9F9F9] font-medium rounded-lg text-sm px-5 py-2.5 text-center">비밀번호 재설정 이메일 받기</button>
          </form>
        </div>
      </div>
    );
